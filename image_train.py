...
# --- EDIT 1: Import the new floorset data loader ---
...
def main():
    ...
    # --- EDIT 2: Add a condition to select the correct data loader ---
    if args.dataset == 'rplan':
        ...
        data = load_floorset_data(
            ...
            analog_bit=args.analog_bit,
            set_name=args.set_name,
            # You can add a command-line argument for data_dir if you want
